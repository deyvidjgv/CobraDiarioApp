...
/** Mismo path que dibuja src/components/ui/Logo.jsx (el rombo de la marca). */
export const DIAMOND_PATH = 'M12 2.4 21.6 12 12 21.6 2.4 12Z';

/** IconPigFilled de @tabler/icons-react — ya es dependencia del proyecto. */
export const PIG_PATH =
...
/** Interpolador real entre el rombo y el marranito (flubber re-muestrea
 * ambas formas en puntos comparables, como MorphSVGPlugin pero gratis). */
export const morphDiamondToPig = interpolate(DIAMOND_PATH, PIG_PATH, {
