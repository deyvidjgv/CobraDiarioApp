    ...
    <div className="pb-24">
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-surface rounded-xl p-4 border border-line">
            <p className="text-[11px] text-primary-light/70 uppercase">Créditos activos</p>
          ...
          {tabs.map(({ id, label, Icon }) => (
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 rounded-lg px-2 py-2 text-xs font-medium transition ${
                tab === id ? "bg-surface text-primary shadow-sm" : "text-primary-light/75 hover:text-primary"
              }`}
            >
        ...
        <div className="space-y-2">
          {tab === "clientes" &&
            (clients.length === 0 ? (
              ...
              clients.map((c) => (
                <div
                  key={c.id}
                  className="bg-surface rounded-xl px-4 py-3 border border-line flex items-center gap-3"
                >
          ...
          {tab === "creditos" &&
            (loans.length === 0 ? (
              <p className="text-sm text-primary-light/70 text-center py-6">Sin créditos</p>
            ) : (
              loans.map((l) => {
                ...
                return (
                  <button
                    ...
                    className="w-full bg-surface rounded-xl px-4 py-3 border border-line flex items-center justify-between gap-3 text-left"
                  >
          ...
          {tab === "cobros" &&
            (cobros.length === 0 ? (
              ...
              cobros.map((m) => (
                <div
                  key={m.id}
                  className="bg-surface rounded-xl px-4 py-3 border border-line flex items-center justify-between"
                >
                  <div>
                    <p className="text-sm font-medium text-primary">
